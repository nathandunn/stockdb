...
<html>
	...
	<body>
		<a href="#create-phylum" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-phylum" class="content scaffold-create" role="main">
