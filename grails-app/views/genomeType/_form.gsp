...
<li class="add">
<g:link controller="genome" action="create" params="['genomeType.id': genomeTypeInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'genome.label', default: 'Genome')])}</g:link>
</li>
</ul>
