...
<html>
	...
	<body>
		<a href="#list-strainGenotype" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
			...
			<table>
				...
				<g:each in="${strainGenotypeInstanceList}" status="i" var="strainGenotypeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${strainGenotypeInstance.id}">${fieldValue(bean: strainGenotypeInstance, field: "name")}</g:link></td>
