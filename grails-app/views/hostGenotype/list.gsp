<%@ page import="edu.uoregon.stockdb.ResearcherService; edu.uoregon.stockdb.HostGenotype" %>
<!DOCTYPE html>
<html>
<head>
...
<body>
<a href="#list-hostGenotype" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-hostGenotype" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="zfinId"
                              title="${message(code: 'hostGenotype.zfinId.label', default: 'Zfin Id')}"/>
        ...
        <g:each in="${hostGenotypeInstanceList}" status="i" var="hostGenotypeInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${hostGenotypeInstance.id}">${fieldValue(bean: hostGenotypeInstance, field: "name")}</g:link></td>
