...
<div class="fieldcontain ${hasErrors(bean: strainInstance, field: 'genus', 'error')} required">
    ...
    <g:select id="genus" name="genus.id" from="${edu.uoregon.stockdb.Genus.list()}" optionKey="id" required=""
              value="${strainInstance?.genus?.id}" class="many-to-one"
              optionValue="name"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: strainInstance, field: 'parentStrain', 'error')} required">
    ...
    <g:select id="parentStrain" name="parentStrain.id" from="${edu.uoregon.stockdb.Strain.list()}" optionKey="id"
              required="" value="${strainInstance?.parentStrain?.id}" class="many-to-one"
              optionValue="name"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: strainInstance, field: 'phylum', 'error')} required">
    ...
    <g:select id="phylum" name="phylum.id" from="${edu.uoregon.stockdb.Phylum.list()}" optionKey="id" required=""
              value="${strainInstance?.phylum?.id}" class="many-to-one"
              optionValue="name"/>
</div>
