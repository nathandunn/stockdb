...
<html>
	...
	<body>
		<a href="#list-phenotype" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
			...
			<table>
				...
				<g:each in="${phenotypeInstanceList}" status="i" var="phenotypeInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${phenotypeInstance.id}">${fieldValue(bean: phenotypeInstance, field: "name")}</g:link></td>
					
						<td>${fieldValue(bean: phenotypeInstance, field: "url")}</td>
