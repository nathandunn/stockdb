...
<div class="fieldcontain ${hasErrors(bean: hostOriginInstance, field: 'genus', 'error')} required">
	...
	<g:select id="genus" name="genus.id" from="${edu.uoregon.stockdb.Genus.list()}" optionKey="id" required="" value="${hostOriginInstance?.genus?.id}" class="many-to-one"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: hostOriginInstance, field: 'phylum', 'error')} required">
	...
	<g:select id="phylum" name="phylum.id" from="${edu.uoregon.stockdb.Phylum.list()}" optionKey="id" required="" value="${hostOriginInstance?.phylum?.id}" class="many-to-one"/>
</div>
