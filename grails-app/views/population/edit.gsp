...
<html>
	...
	<body>
		<a href="#edit-population" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-population" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${populationInstance?.version}" />
				<fieldset class="form">
